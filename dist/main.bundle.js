...
var FusehomeComponent = (function () {
    ...
    FusehomeComponent.prototype.getData = function (startTime, endTime) {
        ...
        this.mainServ.APIServ.get("clients/onlineUsersIsp?mobile=" + this.form.value['mobile'] + "&location=" + this.form.value['location'].routerName + "&from=" + this.form.value['from'] + "&to=" + this.form.value['to'] + "&ip=" + this.form.value['ip']).subscribe(function (data) {
            if (_this.mainServ.APIServ.getErrorCode() == 0) {
                _this.rows = data;
            }
        });
